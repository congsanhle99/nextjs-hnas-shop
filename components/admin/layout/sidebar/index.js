...
import { RiCoupon3Fill, RiLogoutCircleLine, RiSettingsLine } from "react-icons/ri";
  ...
  return (
    <div className={`${styles.sidebar} ${expand ? styles.opened : ""}`}>
      <div className={styles.sidebar__toggle} onClick={() => handleExpand()}>
        <div style={{ transform: `${expand ? "rotate(180deg)" : ""}`, transition: "all 0.2s ease" }}>
          <MdArrowForwardIos />
        </div>
      </div>
      <div className={styles.sidebar__container}>
        ...
        <div className={styles.sidebar__dropdown}>
          <div className={styles.sidebar__dropdown_heading}>
            <div className={styles.show}>Coupon</div>
          </div>
          <ul className={styles.sidebar__list}>
